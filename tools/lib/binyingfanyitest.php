...
$clientID       = "ajiang";
    ...
    $to="de";	
    //HTTP Detect Method URL.
	$url="http://api.microsofttranslator.com/v2/Http.svc/Translate?text=".urlencode($inputStr)."&from=".$from ."&to=".$to;
    $detectMethodUrl = $url;
	
	
//	"http://api.microsofttranslator.com/v2/Http.svc/Translate?text=".$inputStr."&from=".$from ."&to=".$to;
    //Call the curlRequest.
    $strResponse = $translatorObj->curlRequest($detectMethodUrl, $authHeader);
